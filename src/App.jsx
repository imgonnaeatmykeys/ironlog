...
body{background:#0a0a0a;color:#e8e8e8;font-family:'Barlow',sans-serif;-webkit-tap-highlight-color:transparent;padding-top:env(safe-area-inset-top);padding-bottom:env(safe-area-inset-bottom)}
